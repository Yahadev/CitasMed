                        ...
                        <li class="nav-item dropdown hidden-caret">
                            ...
                            <ul class="dropdown-menu dropdown-user animated fadeIn">
                                <div class="dropdown-user-scroll scrollbar-outer">
                                    <li>
                                        <div class="user-box">
                                            <div class="avatar-lg"><img src="<?= base_url('assets/img/profileadm.jpg') ?>" alt="image profile" class="avatar-img rounded"></div>
                                            <div class="u-text">
                                    ...
                                    <li>
                                        ...
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="/cerrar-sesion">Logout</a>
                                    </li>
                                </div>
                            </ul>
                        </li>
